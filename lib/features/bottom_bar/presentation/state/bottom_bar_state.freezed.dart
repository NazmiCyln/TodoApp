...
class _$BottomBarStateImpl implements _BottomBarState {
  const _$BottomBarStateImpl({required this.failure, required this.isLoading});
  ...
  @override
  String toString() {
    return 'BottomBarState(failure: $failure, isLoading: $isLoading)';
  }
...
abstract class _BottomBarState implements BottomBarState {
  const factory _BottomBarState(
      ...
      required final bool isLoading}) = _$BottomBarStateImpl;
